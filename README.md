...
This is a fork of the project by [Brad Frost](https://github.com/bradfrost/project-hub), and works by modifying a `.json`-file.

Simply edit the contents of the `project.json` to your project's need.
