...
},{"./src/reverse-sorted-index.js":3,"backbone":4,"backbone-collection-proxy":1,"underscore":28}],3:[function(require,module,exports){
...
},{"underscore":28}],4:[function(require,module,exports){
(function (global){
//     Backbone.js 1.2.3
...
},{"jquery":25,"underscore":28}],5:[function(require,module,exports){
'use strict';
...
hub.fetch(function() {
  ...
  document.title = this.project.get('name');
  return $('h1#project-name').html(this.project.get('name'));
});


},{"./classes/Hub.coffee":30,"jquery":25}],30:[function(require,module,exports){
var $, Backbone, Hub, SortedCollection, _, moment;
...
Hub = (function() {
  function Hub(el) {
    this.el = el;
    this.template = require('../../templates/item.hbs');
    this.models = {};
    this.collections = {};
    this.views = {};
  ...
  Hub.prototype.createViews = function() {
    return this.views.Timeline = Backbone.View.extend({
      el: this.el,
  ...
  Hub.prototype.initialize = function() {
    this.project = new this.models.Project();
    this.milestones = new this.collections.Milestones();
    this.milestones.sort();
    return this.timelineView = new this.views.Timeline({
      collection: this.milestones
    });
  };

  Hub.prototype.fetch = function(callback) {
    var that;
    that = this;
...
},{"../../templates/item.hbs":31,"backbone":4,"backbone-sorted-collection":2,"jquery":25,"moment":27,"moment/locale/nb":26,"underscore":28}],31:[function(require,module,exports){
...
module.exports = HandlebarsCompiler.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "	<li class=\"tl-node\">\n"
    ...
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.date : depth0),{"name":"if","hash":{},"fn":container.program(6, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "	</li>\n";
},"2":function(container,depth0,helpers,partials,data) {
    var helper;

  return "			<div class=\"tl-stamp\">"
  ...
  return "			<div class=\"tl-content\">"
    + container.escapeExpression(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"title","hash":{},"data":data}) : helper)))
    + "</div>\n";
},"6":function(container,depth0,helpers,partials,data) {
    var stack1, helper, alias1=depth0 != null ? depth0 : {};

  return ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.link : depth0),{"name":"if","hash":{},"fn":container.program(7, data, 0),"inverse":container.program(9, data, 0),"data":data})) != null ? stack1 : "")
    + "				"
    ...
    + "\n"
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.link : depth0),{"name":"if","hash":{},"fn":container.program(11, data, 0),"inverse":container.program(13, data, 0),"data":data})) != null ? stack1 : "");
